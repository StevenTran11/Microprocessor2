...
volatile const int SRCLK = 11;   // Pin connected to SRCLK/ST_CP of 74HC595. Shift register clock
volatile const int RCLK = 12;    // Pin connected to RCLK/SH_CP of 74HC595. Storage register clock
volatile const int SER = 13;     // Pin connected to SER/DS of 74HC595. Data line
// SPI
//volatile const int MOSI = 51;
//volatile const int MISO = 50;
//volatile const int SCK = 52;
//volatile const int SS = 53;
